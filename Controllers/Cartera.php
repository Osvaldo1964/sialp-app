<?php
    ...
    class Cartera extends Controllers
    {
        ...
        public function Pedidos()
        {
            ...
            $data['page_tag']   = "Cartera";
            $data['page_title'] = "CARTERA <small> Cmr Pos Facturación </small>";
            $data['page_name']  = "cartera";
            $data['page_functions_js'] = "functions_cartera.js";

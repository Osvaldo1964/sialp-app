...
<head>
    ...
    <meta name="author" content="Osvaldo J. Villalobos Cortina">
        ...
        <div class="login-box">
            ...
            <form class="login-form" name="formLogin" id="formLogin" action="">
                ...
                <div class="form-group btn-container">
                    <button class="btn btn-primary btn-block"><i class="fas fa-unlock fa-lg fa-fw"></i>INGRESO</button>
                </div>
            </form>
            <form id="formResetPass" name="formResetPass" class="forget-form" action="">
                ...
                <div class="form-group btn-container">
                    <button type="submit" class="btn btn-primary btn-block"><i class="fas fa-unlock fa-lg fa-fw"></i>REINICIAR</button>
                </div>

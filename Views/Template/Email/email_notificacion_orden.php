...
<body>
	<div>
		...
		<table>
			<tr>
				<td width="33.33%">
					<img class="logo" src="<?= media(); ?>/tienda/images/icons/logo_vital3.png" alt="Logo" width="180" >
				</td>
				<td width="33.33%">
					...
					<div class="text-right">
						<p>
                            ...
                            <?php }else{ ?>
									...
									Forma de Pago: <?= $orden['desTipopago'] ?>
                            <?php } ?>
						</p>
					</div>
				</td>				
		...
		<table>
			...
			<?php
				if (count($detalle) > 0){
					...
					foreach ($detalle as $producto){
						$precio = formatMoney($producto['vtaBody']);
						$importe = formatMoney($precio  * $producto['canBody']);
						$subtotal += $importe;
			?>
		    <tr>
		  ...
		  <tfoot>
		  		...
		  		<tr>
		  			...
		  			<td class="text-right"><?= SMONEY . ' ' . formatMoney($orden['domPedido']) ?></td>
		  		</tr>
		  		<tr>

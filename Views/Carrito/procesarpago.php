                                ...
                                <form id="formRegister">
                                    <div class="row">
                                        <div class="col col-md-6 form-group">
                                            ...
                                            <input type="text" class="form-control valid validText" id="txtnomCliente" name="txtnomCliente" required="">
                                        </div>
                                        <div class="col col-md-6 form-group">
                                            <label for="txtapeCliente">Apellidos</label>
                                            <input type="text" class="form-control valid validText" id="txtapeCliente" name="txtapeCliente" required="">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col col-md-6 form-group">
                                            <label for="txttelCliente">Teléfono</label>
                                            <input type="text" class="form-control valid validNumber" id="txttelCliente" name="txttelCliente" required="" onkeypress="return controlTag(event);">
                                        </div>
                                        <div class="col col-md-6 form-group">
                                            <label for="txtemaCliente">Email</label>
                                            <input type="email" class="form-control valid validEmail" id="txtemaCliente" name="txtemaCliente" required="">
                                        </div>
                                    </div>
                                ...
                                <div id="divtipopago" class="notblock">
                                    ...
                                    <div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
                                        <select id="listtipopago" class="js-select2" name="listtipopago">
                                            ...
                                            ?>
                                                        <option value="<?= $tipopago['idTipopago'] ?>"><?= $tipopago['desTipopago'] ?></option>
                                            <?php
                                                    }
                                                }
                                            } ?>

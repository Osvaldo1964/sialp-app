<?php
	...
	const BASE_URL = "http://localhost/sialp-app";
	...
	const NOMBRE_REMITENTE = "Sistema Integrado de Alumbrado Público";
	const EMAIL_REMITENTE = "correspondencia@sialp-app.com";
	const NOMBRE_EMPRESA = "SIALP-APP";
	const WEB_EMPRESA = "www.sialp-app.com";
